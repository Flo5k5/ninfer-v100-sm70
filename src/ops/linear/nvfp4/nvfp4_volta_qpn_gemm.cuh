...
// the 6144-residual, the attention and GDN output projections, which the profiles with NVFP4
// outputs load prepacked. SPLITK=16 on the prepacked 6144-residual, as on `down`, has not been
// measured.
