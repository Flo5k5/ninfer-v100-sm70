...
// small-T route uses the key-major tensor-core kernel in small_t_i8_volta_kt.cuh and this kernel
// is never launched. Compile it away below sm_80 so an unreachable instantiation cannot emit
// illegal ops.
