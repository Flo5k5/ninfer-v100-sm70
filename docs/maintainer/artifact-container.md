...
metadata name and the official recipe name. The README's [Models](../../README.md#models) section
says which artifacts load on this port. The framing and directory sections describe the version-2
file format that v3 replaced.
...
| `(model_id, weights_id)` | `qwen3.6-27b/groupwise-int`, `qwen3.6-27b/nvfp4`, `qwen3.6-35b-a3b/groupwise-int`, `qwen3.8-27b/groupwise-int`, `qwen3.8-27b/nvfp4`, `qwen3.8-27b/nvfp4-full-a`, `qwen3.8-27b/nvfp4-full-b`, `qwen3.8-27b/nvfp4-full-c` | respective [Qwen3.6-27B](qwen3.6-27b-artifact.md), [Qwen3.6-35B-A3B](qwen3.6-35b-a3b-artifact.md), or [Qwen3.8-27B](qwen3.8-27b-artifact.md) artifact reference |
