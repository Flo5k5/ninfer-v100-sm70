...
artifacts load today. The Qwen3.6-27B and Qwen3.8-27B `groupwise-int` artifacts now resolve and bind
their weights but still await a load check on a V100, and the Qwen3.6-35B-A3B MoE weights have no v3
binding yet.
