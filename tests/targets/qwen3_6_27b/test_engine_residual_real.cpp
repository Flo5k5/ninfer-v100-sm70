...
// (qwen3.8-27b/nvfp4, nvfp4-full-a or nvfp4-full-b) in the production decode configuration: MTP
// with four drafts and the optimized proposal head, CUDA graphs, INT8 KV and 2048-token prefill
// chunks. The prompt spans two prefill chunks (the wide FP32 residual projections and split-D
// attention), then greedy decoding runs through the captured MTP verify and draft graphs with the
// FP32 stream.
//
