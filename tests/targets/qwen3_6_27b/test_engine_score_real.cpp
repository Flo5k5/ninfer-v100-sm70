...
// NINFER_QWEN3_8_27B_NVFP4_WEIGHTS (qwen3.8-27b/nvfp4 or nvfp4-full-a). The same checks run on an
// FP32-residual engine, and both of its scoring shapes must agree with a BF16-residual engine on
// the same artifact.
