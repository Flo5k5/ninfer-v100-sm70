...
`T=1..8` sweep is the production MTP verification interval; Record begins at `T=2`.
...
counts, batched sampling at `B=1,2,4,8`, and every MTP window `K=1..7`. With no arguments it runs
