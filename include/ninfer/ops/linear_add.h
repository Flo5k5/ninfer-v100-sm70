 ...
 *   aligned FP32 residual (an FP32 residual stream), updated with a single rounding to FP32, on
 *   their A16 routes: A16Only, or AllowA8/AllowA4 below the width where the A8/W4A4 route takes
 *   over. Those two routes write BF16 and reject an FP32 residual.
 *
 * Numeric:
